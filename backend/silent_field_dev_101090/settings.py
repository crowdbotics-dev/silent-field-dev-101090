"""
Django settings for silent_field_dev_101090 project.
...
ROOT_URLCONF = 'silent_field_dev_101090.urls'
...
WSGI_APPLICATION = 'silent_field_dev_101090.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_field_dev_101090 API",
    "DESCRIPTION": "API documentation for silent_field_dev_101090 App",
    "VERSION": "v1",
}
